...
export default function Insights({ posts }: InsightsPageProps) {
  return (
    <>
      <Head>
        <title>Insights - Assure</title>
        <meta name="description" content="Latest insights and articles from Assure" />
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          {posts.length === 0 ? (
            <div className="text-center text-gray-500 py-12">
              <p className="text-xl mb-4">No posts found for Assure.</p>
              <p className="mb-4">Create content in Sanity Studio and tag it with &apos;assure&apos; site.</p>
              <p>
                <Link href="http://localhost:3333" className="text-blue-600 hover:underline">
                  Open Sanity Studio
                </Link>
              </p>
            </div>
...
export const getStaticProps: GetStaticProps = async () => {
  try {
    // Fetch posts for the 'assure' site
    const posts = await getPosts('assure', 20)
